  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-visible bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center overflow-visible">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 backdrop-blur-sm mb-8 animate-fade-in-up animation-delay-200">
        ...
        <h1 className="flex flex-col font-bold text-white mb-6 leading-none">
          <span className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl mb-4 animate-fade-in-up animation-delay-400">
            Hello, I&apos;m
          </span>

          <span className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl bg-gradient-to-r from-cyan-400 via-blue-500 to-teal-400 bg-clip-text text-transparent animate-gradient animate-fade-in-up animation-delay-600 leading-[1.12]">
            Manojkumar
          </span>
        </h1>

        <p className="text-lg sm:text-xl md:text-2xl text-slate-300 max-w-4xl mx-auto mb-12 leading-relaxed animate-fade-in-up animation-delay-800">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 animate-fade-in-up animation-delay-1000">
          <a
            ...
            className="group relative px-8 py-4 bg-gradient-to-r from-[#45a8ea] via-[#a29562] to-[#4a155c] border-1 border-[#8675c1] rounded-xl font-semibold text-white overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/50 hover:scale-105 active:scale-95 flex items-center gap-2"
          >
      ...
      {/* Scroll Indicator */}
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20 animate-fade-in-up animation-delay-1200">
